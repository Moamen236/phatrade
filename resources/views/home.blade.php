        ...
        <div class="container">
            <div class="map-container">
                <div class="map-content">
                    ...
                    <div class="map-text">
                        <h2 style="font-weight: 700; color:rgb(255, 255, 255); letter-spacing: 1px; background-color:rgb(75, 159, 255); padding: 15px 20px; border-radius: 32px 0 32px 32px;">Our Quality Control Department</h2>
                        <p style="font-size: 18px; line-height: 1.8;">is <strong>very active</strong>, <strong>very well equipped</strong> and run by <strong>good technicians</strong>.
                            Also they have a <strong>very strict system</strong> for registration which allow us full traceability of any
